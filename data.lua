...
local bot_item =
{
  ...
  icon = "__Nerfed_Companion_Drones__/drone-icon.png",
  icon_size = 200,
  subgroup = "companion",
...
--inserter_beam.head =
--{
--  filename = "__Nerfed_Companion_Drones__/data//hr-fast-inserter-hand-closed.png",
--  priority = "extra-high",
--  width = 164,
--  height = 72,
--  scale = 0.25
...
--inserter_beam.body =
--{
--  filename = "__Nerfed_Companion_Drones__/data//hr-fast-inserter-hand-base.png",
--  priority = "extra-high",
--  height = 32,
--  width = 136,
--  scale = 0.25
...
local drone =
{
  ...
  {
    filename = "__Nerfed_Companion_Drones__/drone-map.png",
    flags = {"icon"},
    size = {128, 128},
    scale = 0.25
  }
...
local drone_item =
{
  ...
  name = "companion",
  icon = "__Nerfed_Companion_Drones__/drone-icon.png",
  icon_tintable = "__Nerfed_Companion_Drones__/drone-icon-tintable.png",
  icon_tintable_mask = "__Nerfed_Companion_Drones__/drone-icon-mask.png",
  icon_size = 200,
  subgroup = "companion",
...
local attack_icon =
{
  filename = "__Nerfed_Companion_Drones__/drone-attack-shortcut.png",
...
{
  filename = "__Nerfed_Companion_Drones__/drone-attack-shortcut-disabled.png",
  priority = "extra-high-no-scale",
  size = 200,
  scale = 1,
  flags = {"icon"},
...
{
  filename = "__Nerfed_Companion_Drones__/drone-construction-shortcut.png",
  priority = "extra-high-no-scale",
  size = 200,
  scale = 1,
  flags = {"icon"},
...
{
  filename = "__Nerfed_Companion_Drones__/drone-construction-shortcut-disabled.png",
  priority = "extra-high-no-scale",
  size = 200,
  scale = 1,
  flags = {"icon"},
